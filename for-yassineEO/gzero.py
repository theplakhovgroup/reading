...
commit_temp = f'Updated Gzero RSS feed with newest data on {timestamp}'
...
def create_rss_feed(filtered_entries, output_file):
    ...
    description.text = "This is a custom Gzero RSS feed compiled by the Plakhov Group Reading List Team."
...
# Example usage
rss_feed_url = 'https://www.inoreader.com/stream/user/1005212654/tag/WC%20Gzero%20%28Beta%29'  # Your RSS feed URL
