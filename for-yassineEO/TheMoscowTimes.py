...
commit_temp = f'Updated The Moscow Times RSS feed with newest data on {timestamp}'
...
def create_rss_feed(filtered_entries, output_file):
    ...
    title.text = "The Moscow Times"

    link = SubElement(channel, 'link')
    link.text = "https://www.theplakhovgroup.ca/projects/reading-list"  # Replace with your site URL

    description = SubElement(channel, 'description')
    description.text = "This is a custom Moscow Times RSS feed compiled by the Plakhov Group Reading List Team."
...
# Example usage
rss_feed_url = 'https://www.inoreader.com/stream/user/1005212654/tag/WC%20Moscow%20Times%20%28Beta%29'  # Your RSS feed URL
min_word_count = 600  # Set your desired minimum word count
output_file = 'filtered_feeder.xml'  # Path to save the new RSS feed

# GitHub details
repo = 'theplakhovgroup/reading'  # Replace with your repo name
path_in_repo = 'moscowtimes.xml'
