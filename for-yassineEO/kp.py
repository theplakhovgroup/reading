...
commit_temp = f'Updated Kyiv Post RSS feed with newest data on {timestamp}'
...
def create_rss_feed(filtered_entries, output_file):
    ...
    title.text = "Kyiv Post"

    link = SubElement(channel, 'link')
    link.text = "https://www.theplakhovgroup.ca/projects/reading-list"  # Replace with your site URL

    description = SubElement(channel, 'description')
    description.text = "This is a custom Kyiv Post feed compiled by the Plakhov Group Reading List Team."
...
# Example usage
rss_feed_url = 'https://www.inoreader.com/stream/user/1005212654/tag/WC%20Kyiv%20Post%20%28Beta%29'  # Your RSS feed URL
